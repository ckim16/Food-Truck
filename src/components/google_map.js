...
export default class GoogleMap extends Component {
  ...
  componentDidMount(newProps) {
    const latLong = {lat: 37.742972, lng: -122.431297};
  ...
  // componentWillMount() {
  //   console.log('this', this.props.list);
  //   if (this.props.list.length !== 0) {
  //     return this.prop.list.map((truck) => {
  //       return new google.maps.Marker({
  //         map: map,
  //         position: new google.maps.LatLng({lat: truck.latitude, long: truck.longitude})
  //       });
  //     });  
  //   } 
  // }
